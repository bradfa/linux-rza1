...
{
	if (axis == ABS_Y) {
		rza1_pfc_pin_assign(P5_8,  PMODE, DIR_OUT);	
		rza1_pfc_pin_set(P5_8, 1);
		rza1_pfc_pin_assign(P8_14, PMODE, DIR_OUT);	
		rza1_pfc_pin_set(P8_14, 0);
		rza1_pfc_pin_assign(P8_15, PMODE, DIR_IN);	
		rza1_pfc_pin_assign(P7_0,  PMODE, DIR_IN);	

		rza1_pfc_pin_assign(P1_9, ALT1, DIR_PIPC);

	} else {
		rza1_pfc_pin_assign(P8_15, PMODE, DIR_OUT);	
		rza1_pfc_pin_set(P8_15, 1);
		rza1_pfc_pin_assign(P7_0,  PMODE, DIR_OUT);	
		rza1_pfc_pin_set(P7_0, 0);
		rza1_pfc_pin_assign(P5_8,  PMODE, DIR_IN);	
		rza1_pfc_pin_assign(P8_14, PMODE, DIR_IN);	

		rza1_pfc_pin_assign(P1_11, ALT1, DIR_PIPC);
	}
}
				      ...
				      int valid)
{
	...
	if (abs(x - x_old) > SH_ADC_FILTER_TH || abs(y - y_old) > SH_ADC_FILTER_TH) {
		x = x_old;
		y = y_old;
	} else {
		x_old = x;
