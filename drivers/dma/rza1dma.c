...
#if 0
static u32 rza1dma_readl(struct rza1dma_engine *rza1dma, unsigned offset)
{
	return __raw_readl(rza1dma->base + offset);
}
#endif
...
#if 0
	rza1dma->dma_device.copy_align = 2; /* 2^2 = 4 bytes alignment */
#else
