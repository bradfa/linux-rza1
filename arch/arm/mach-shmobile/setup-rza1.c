...
{
	/* for WM8978 */
	rza1_pfc_pin_assign(P4_0, ALT7, DIR_PIPC);
	rza1_pfc_pin_assign(P4_1, ALT7, DIR_PIPC);
	rza1_pfc_pin_assign(P4_2, ALT7, DIR_PIPC);
	rza1_pfc_pin_assign(P4_3, ALT7, DIR_PIPC);
